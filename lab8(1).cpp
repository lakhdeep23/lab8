...
// EXAM 
// May 19 2016
// i commented some code out that was giving me errors, hopefully you can look at that
// and see where i was going with this... thanks
#include <stdio.h>                                                                                                              
#include <iostream>                                                                                                             
#include <cstdlib>                                                                                                              
#include <ctime>                                                                                                                
...
int main(int argc, char *argv[])
{
  ...
  /*  double tolerance = 0.08;
    ...
    float diff;
    float value;
    printf(" unit test for SBSI...\n");
    cout << "Tolerance: " << tolerance << endl;
    for (int i = 0; i < 79; i==) {
        diff = value - arr[i].sbsi;
        value = bodyShapeIndex;
